...
public abstract class GroceryBill implements Serializable {
	...
	protected GroceryBill() {

	}

	protected GroceryBill(ShoppingClerk shoppingClerk) {
		super();
		this.shoppingClerk = shoppingClerk;
	}

	protected GroceryBill(ShoppingClerk shoppingClerk, List<Item> itemList, LocalDateTime dateCreated){
		this.shoppingClerk = shoppingClerk;
